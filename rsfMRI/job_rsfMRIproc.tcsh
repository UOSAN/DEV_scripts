...
set wave=wave2
echo $wave
set pipeline=rsfMRI_preproc_"$wave"

# set data directories
set top_dir=/projects/sanlab/shared/"${group_id}"
echo $top_dir
set anat_dir=$top_dir/bids_data/derivatives/freesurfer_"$wave"/$subj/SUMA
echo $anat_dir
set epi_dir=$top_dir/bids_data/"$subj"/ses-"$wave"/func
echo $epi_dir
...
-dsets $epi_dir/"${subj}"_ses-"$wave"_task-rest0?_bold.nii.gz \
