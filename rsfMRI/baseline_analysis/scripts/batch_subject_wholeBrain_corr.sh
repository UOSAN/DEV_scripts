...
# Set subject list
subject_list=`cat /projects/sanlab/shared/DEV/DEV_scripts/rsfMRI/baseline_analysis/baseline_connectivity_subjectList_nocrash.txt` 
...
for subject in $subject_list; do
    ...
    sbatch --export ALL,subid=${subid} \
		   ...
		   --account=sanlab \
		   /projects/sanlab/shared/DEV/DEV_scripts/rsfMRI/baseline_analysis/scripts/job_subject_wholeBrain_corr.sh
done