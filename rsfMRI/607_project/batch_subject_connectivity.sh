...
# Set the directories
output_dir=/projects/sanlab/shared/DEV/DEV_scripts/rsfMRI/607_project/outputs

# Set subject list
subject_list=`cat /projects/sanlab/shared/DEV/DEV_scripts/rsfMRI/607_project/607_subjectList.txt` 
...
for subject in $subject_list; do
    ...
    sbatch --export ALL,subid=${subid} \
		   ...
		   --account=sanlab \
		   /projects/sanlab/shared/DEV/DEV_scripts/rsfMRI/607_project/job_subject_connectivity.sh
done