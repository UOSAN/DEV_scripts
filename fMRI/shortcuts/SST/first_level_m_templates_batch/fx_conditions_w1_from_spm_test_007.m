%-----------------------------------------------------------------------
% Job saved on 11-Sep-2021 08:28:51 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/SST/betaseries/DEV004_modified.mat'};
...
matlabbatch{4}.spm.stats.fmri_est.spmmat = '<UNDEFINED>';
