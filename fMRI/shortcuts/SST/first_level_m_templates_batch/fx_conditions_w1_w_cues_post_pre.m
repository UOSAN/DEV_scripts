...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/SST/full_duration/posterror_cues_no_rt/DEV004_1_SST1.mat'};
...
matlabbatch{5}.spm.stats.con.consess{2}.tcon.name = 'CueFollowing(FS>CS)';
