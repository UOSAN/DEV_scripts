...
for i = 1:numel(waves)
    ...
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '.*task-WTP_acq-1_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz';
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-WTP_acq-1_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '.*task-WTP_acq-2_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz';
    matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{6}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-WTP_acq-2_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{9}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '.*task-WTP_acq-3_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz';
    matlabbatch{9}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{10}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-WTP_acq-3_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
    ...
    matlabbatch{13}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '.*task-WTP_acq-4_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz';
    matlabbatch{13}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
    matlabbatch{14}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (.*task-WTP_acq-4_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{13}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
