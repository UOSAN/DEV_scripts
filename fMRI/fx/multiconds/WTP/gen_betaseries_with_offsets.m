function gen_betaseries_with_offsets(writeDir,onset_offsets)
%GEN_BETASERIES_WITH_OFFSETS Goes through and does the main content of
%betaseries.m with several custom features
%mainly this one will use 'offsets', generating events that have an offset
%from the original event file.
