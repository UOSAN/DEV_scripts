...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/Users/bensmith/Documents/data/DEV/bids_data/derivatives/fmriprep/sub-DEV121/ses-wave1/func/'};
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 's6_sub-DEV121_ses-wave1_task-SST_acq-1_bold_space-MNI152NLin2009cAsym_preproc.nii';
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{2}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (s6_sub-DEV121_ses-wave1_task-SST_acq-1_bold_space-MNI152NLin2009cAsym_preproc.nii)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{2}.spm.util.exp_frames.frames = Inf;
matlabbatch{3}.spm.stats.fmri_spec.dir = {'/Users/bensmith/Documents/data/DEV/nonbids_data/fMRI/fx/models/SST/wave1/posterror_conditions_w_pss/sub-DEV121'};
...
matlabbatch{3}.spm.stats.fmri_spec.sess.multi = {'/Users/bensmith/Documents/code/DEV_scripts/fMRI/fx/multiconds/SST/full_duration/posterror_conditions_w_pss/DEV121_1_SST1.mat'};
matlabbatch{3}.spm.stats.fmri_spec.sess.regress = struct('name', {}, 'val', {});
matlabbatch{3}.spm.stats.fmri_spec.sess.multi_reg = {'/Users/bensmith/Documents/code/DEV_scripts/fMRI/fx/motion/auto-motion-fmriprep/rp_txt/rp_DEV121_1_SST_1.txt'};
...
matlabbatch{3}.spm.stats.fmri_spec.mask = {'~/spm12/canonical/MNI152_T1_1mm_brain_mask.nii,1'};
...
matlabbatch{5}.spm.stats.con.consess{1}.tcon.weights = [1 0 -1];
...
matlabbatch{5}.spm.stats.con.consess{2}.tcon.weights = [-1 0 1];
matlabbatch{5}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{5}.spm.stats.con.consess{3}.tcon.name = 'SlowingCGFollowingCS';
matlabbatch{5}.spm.stats.con.consess{3}.tcon.weights = [0 1 0];
matlabbatch{5}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{5}.spm.stats.con.consess{4}.tcon.name = 'SlowingCGFollowingFS';
