...
trial_summary_data <- tpc_long %>% 
  ...
  summarise(
    ...
    trough = min(value[offset>=5.0 & offset <=11.0],na.rm = TRUE),
    peak_time = offset[offset>=1.0 & offset <=5.0][value[offset>=1.0 & offset <=5.0]==max(value[offset>=1.0 & offset <=5.0],na.rm = TRUE)],
    trough_time = offset[offset>=5.0 & offset <=11.0][value[offset>=5.0 & offset <=11.0]==min(value[offset>=5.0 & offset <=11.0],na.rm = TRUE)]
  )
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_c +I(trial_n_c^2) + post_pre_rt_change + (1+ post_pre_rt_change | subid),
  FS_neural_behav_p
  )
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_c +post_pre_rt_change + (1+ post_pre_rt_change | subid),
  FS_neural_behav_p
  )
summary(model_full_effects)
...
model_fixed_effects <- lme4::lmer(
   trough ~ trial_n_c +post_pre_rt_change + (1 | subid),
  FS_neural_behav_p
  )
...
model_random_only <- lme4::lmer(
   trough ~ trial_n_c +(1+ post_pre_rt_change | subid),
  FS_neural_behav_p
  )
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_c +lagging_rt + leading_rt + (1+ lagging_rt + leading_rt | subid),
  FS_neural_behav_p
  )
summary(model_full_effects)

model_fixed_effects <- lme4::lmer(
   trough ~ trial_n_c +lagging_rt + leading_rt + (1 | subid),
  FS_neural_behav_p
  )
summary(model_fixed_effects)
...
model_random_only <- lme4::lmer(
   trough ~ trial_n_c +(1+ lagging_rt + leading_rt | subid),
  FS_neural_behav_p
  )
summary(model_random_only)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_c +lagging_rt + post_pre_rt_change + (1+ lagging_rt + post_pre_rt_change | subid),
  FS_neural_behav_p
  )
summary(model_full_effects)

model_fixed_effects <- lme4::lmer(
   trough ~ trial_n_c +lagging_rt + post_pre_rt_change + (1 | subid),
  FS_neural_behav_p
  )
summary(model_fixed_effects)
...
model_random_only <- lme4::lmer(
   trough ~ trial_n_c +(1+ lagging_rt + post_pre_rt_change | subid),
  FS_neural_behav_p
  )
summary(model_random_only)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")  | subid),
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+I(trial_n_s^2)+ condition + post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")  | subid),
  trial_neural_behav_roi
  )
summary(model_full_effects)
```
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + SSD_recorded*condition + post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")  | subid),
  trial_neural_behav_roi
  )
summary(model_full_effects)
```
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop") +SSD_recorded | subid),
  trial_neural_behav_roi
  )
summary(model_full_effects)
```
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + next_last_rt_change + next_last_rt_change:(condition=="FailedStop")+ (1 +next_last_rt_change + next_last_rt_change:(condition=="FailedStop") +SSD_recorded | subid),
  trial_neural_behav_roi
  )
summary(model_full_effects)
```
...
model_fixed_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 + (condition=="FailedStop") +SSD_recorded | subid),
  trial_neural_behav_roi
  )
summary(model_fixed_effects)
...
model_random_only <- lme4::lmer(
   trough ~ trial_n_s+ condition + (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop") +SSD_recorded | subid),
  trial_neural_behav_roi
  )
summary(model_random_only)
...
FS_neural_behav_p$trough_z<-scale(FS_neural_behav_p$trough)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post + trials_since_last_SSD +(1+ post_pre_rt_change | subid),
  FS_neural_behav_p
  )
summary(model_full_effects)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post +(1+ post_pre_rt_change | subid),
  FS_neural_behav_p
  )
summary(model_full_effects)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post +(1+ post_pre_rt_change+P_stop_trial_post | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
summary(model_full_effects)

model_random_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change  +(1+ post_pre_rt_change+P_stop_trial_post | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post+I(P_stop_trial_post^2) +(1+ post_pre_rt_change+P_stop_trial | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
summary(model_full_effects)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post+(trials_since_last_SSD==1) +(1+ post_pre_rt_change+P_stop_trial_post | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
summary(model_full_effects)
...
model_full_effects <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial+(trials_since_last_SSD==1) +(1+ post_pre_rt_change+P_stop_trial | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
summary(model_full_effects)
...
model_P_stop_trial_w_change <- lme4::lmer(
   trough ~ trial_n_n +post_pre_rt_change + P_stop_trial_post + P_stop_trial_change +(1+ post_pre_rt_change+P_stop_trial_post + P_stop_trial_change | subid),
  FS_neural_behav_p %>% filter(trial_n>50)
  )
...
model_P_stop_trial <- lme4::lmer(
   trough_z ~ trial_n_n +post_pre_rt_change_z + P_stop_trial_post_z +(1+ post_pre_rt_change_z + P_stop_trial_post_z | subid),
  FS_neural_behav_p %>% filter(trial_n>=50)
  )
summary(model_P_stop_trial)

model_P_stop_trial_w_no_rt <- lme4::lmer(
   trough_z ~ trial_n_n + P_stop_trial_post_z +(1+ post_pre_rt_change_z + P_stop_trial_post_z | subid),
  FS_neural_behav_p %>% filter(trial_n>=50)
  )
...
model_P_stop_trial_w_no_p_stop_d <- lme4::lmer(
   trough_z ~ trial_n_n +post_pre_rt_change_z +(1+ post_pre_rt_change_z + P_stop_trial_post_z | subid),
  FS_neural_behav_p %>% filter(trial_n>=50)
  )
...
cor.test(fs_by_ppt$mean_trough, fs_by_ppt$RTFS_factor_2,method="spearman")
cor.test(fs_by_ppt$mean_trough, fs_by_ppt$RTFS_factor_1,method="spearman")
cor.test(fs_by_ppt$mean_peak, fs_by_ppt$RTFS_factor_2,method="spearman")
cor.test(fs_by_ppt$mean_peak, fs_by_ppt$RTFS_factor_1,method="spearman")
...
```{r}
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + P_stop_trial_change+ post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop")+ (1 +post_pre_rt_change + post_pre_rt_change:(condition=="FailedStop") + P_stop_trial_change  | subid),
...
```{r}
model_full_effects <- lme4::lmer(
   trough ~ trial_n_s+ condition + +P_stop_trial_change+ post_pre_rt_change +  (1 +post_pre_rt_change +  P_stop_trial_change   | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_full_effects)
...
```{r}
model_P_stop_trial_w_change <- lme4::lmer(
   trough_z ~ trial_n_z +condition + post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change)

model_P_stop_trial_w_change_no_rt <- lme4::lmer(
   trough_z ~ trial_n_z +condition +  P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
...
model_P_stop_trial_w_change_no_p_stop_d <- lme4::lmer(
   trough_z ~ trial_n_z +condition +  post_pre_rt_change_z +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
...
```{r}
model_P_stop_trial_w_change <- lme4::lmer(
   trough_z ~ trial_n_z +condition + post_pre_rt_change_z + P_stop_trial_change_z +(1+ post_pre_rt_change_z + P_stop_trial_change_z  | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change)

model_P_stop_trial_w_change_no_rt <- lme4::lmer(
   trough_z ~ trial_n_z +condition +  P_stop_trial_change_z + P_stop_trial_change_z +(1+ post_pre_rt_change_z + P_stop_trial_change_z  | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change_no_rt)
...
model_P_stop_trial_w_change_no_p_stop_d <- lme4::lmer(
   trough_z ~ trial_n_z +condition +  post_pre_rt_change_z +(1+ post_pre_rt_change_z + P_stop_trial_change_z | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change_no_p_stop_d)
...
```{r}
model_P_stop_trial_w_change <- lme4::lmer(
   trough_z ~ trial_n_z+I(trial_n_z^2) +condition + post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change)

model_P_stop_trial_w_change_no_rt <- lme4::lmer(
   trough_z ~ trial_n_z+I(trial_n_z^2) +condition +  P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change_no_rt)
...
model_P_stop_trial_w_change_no_p_stop_d <- lme4::lmer(
   trough_z ~ trial_n_z+I(trial_n_z^2) +condition +  post_pre_rt_change_z +(1+ post_pre_rt_change_z + P_stop_trial_change_z + P_stop_trial_change_z:(condition=="FailedStop") | subid),
  trial_neural_behav_roi %>% filter(trial_n>50)
  )
summary(model_P_stop_trial_w_change_no_p_stop_d)
