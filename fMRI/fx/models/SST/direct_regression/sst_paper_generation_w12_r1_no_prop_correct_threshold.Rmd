...
output_folder <- "sst_paper_generation_w12_no_prop_correct_threshold_output"
...
```{r}
cache_filepath <- paste0(dropbbox_dir,"sst_paper_generation_w12_no_prop_correct_threshold.Rdata")
...
```{r}
# 
stop("import appropriate code from data_inventory.Rmd")
```
