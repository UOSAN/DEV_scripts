...
FS_neural_behav_FOC <- FS_neural_behav_data_not_na %>% filter(ROI_delateralized=="Frontal Orbital Cortex")
...
model_fixed_effects <- lme4::lmer(
   response_amplitude ~ lagging_rt + reaction_time_clean + leading_rt+(1 | subid),
  FS_neural_behav_data_not_na
  )
summary(model_fixed_effects)
...
model_fixed_effects <- lme4::lmer(
   response_amplitude ~ lagging_rt + leading_rt+(1 + leading_rt| subid),
  FS_neural_behav_data_not_na
  )
summary(model_fixed_effects)
...
model_fixed_effects <- lme4::lmer(
   response_amplitude ~ next_ +lagging_rt+(1 + post_pre_rt_change| subid),
  FS_neural_behav_data_not_na
  )
summary(model_fixed_effects)
...
model_fixed_effects <- lme4::lmer(
   response_amplitude ~ lagging_rt + last_tone_delay+SSD_recorded+ reaction_time_clean+leading_rt+(1 + leading_rt| subid),
  FS_neural_behav_data_not_na
  )
summary(model_fixed_effects)
...
model_fixed_effects <- lme4::lmer(
   response_amplitude ~ last_reaction_time + last_tone_delay+SSD_recorded+ reaction_time_clean+next_reaction_time+(1 + leading_rt| subid),
  FS_neural_behav_data_not_na
  )
summary(model_fixed_effects)
