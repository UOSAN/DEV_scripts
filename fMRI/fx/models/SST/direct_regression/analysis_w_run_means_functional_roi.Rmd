...
trial_tps_compare_conditions<-df_offset %>% pivot_wider(id_cols=c(offset_start),names_from = "condition",values_from="CueFollowing.CS.FS.striatal_cluster_combined")
...
roi_cols <- colnames(time_points_c)[grepl("harvardoxford",colnames(time_points))]
