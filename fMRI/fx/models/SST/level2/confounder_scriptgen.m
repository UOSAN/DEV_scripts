...
%-----------------------------------------------------------------------
spm('defaults','fMRI');
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Users/benjaminsmith/Google Drive/oregon/code/DEV_scripts/fMRI/fx/models/SST/level2/posterror_w_agesex_20230801/CorrectGoFollowing(CS>FS)'};
...
'/Users/benjaminsmith/Google Drive/oregon/data/DEV/nonbids_data/fMRI/fx/models/SST/wave1/posterror_conditions/sub-DEV008/spmT_0001.nii,1'
...
matlabbatch{1}.spm.stats.factorial_design.cov(1).c = [60.25
19.25
24.0
58.0
45.5
...
34.0
43.0];
matlabbatch{1}.spm.stats.factorial_design.cov(1).cname = 'age365';
matlabbatch{1}.spm.stats.factorial_design.cov(1).iCFI = 1;
matlabbatch{1}.spm.stats.factorial_design.cov(1).iCC = 1;

matlabbatch{1}.spm.stats.factorial_design.cov(2).c = [1.0
1.0
2.0
1.0
1.0
...
1.0
1.0];
matlabbatch{1}.spm.stats.factorial_design.cov(2).cname = 'birthsex';
...
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'age365';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'birthsex';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.delete = 1;
matlabbatch{4}.spm.stats.results.spmmat(1) = cfg_dep('Contrast Manager: SPM.mat File', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
matlabbatch{4}.spm.stats.results.conspec(1).titlestr = 'CorrectGoFollowing(CS>FS)';
...
matlabbatch{4}.spm.stats.results.conspec(2).titlestr = 'age365';
...
matlabbatch{4}.spm.stats.results.conspec(3).titlestr = 'birthsex';
