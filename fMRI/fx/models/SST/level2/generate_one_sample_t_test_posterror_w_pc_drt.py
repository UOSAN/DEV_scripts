...
analysis_name = 'posterror_conditions_w_pc_drt'
...
beta_name_list = [
       ...
       'CorrectGoFollowingFailedStopxCgffs_post_current_drt',
        'FailedStopPrecedingCorrectGo',
        'FailedStopPrecedingCorrectGoxFspcg_post_current_drt',
        # 'OtherFailedStop',
        # 'OtherFailedStopxOfs_post_current_drt'
        # 'OtherFailedGo'
    ]
