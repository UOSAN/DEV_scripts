...
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).c = [1
                                                                2.9
                                                                3.8
                                                                0.3];
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).cname = 'SSRT';
...
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).c = [1
                                                                ...
                                                                3
                                                                1.02];
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).cname = 'cov2';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).iCC = 1;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).c = [-0.1
                                                                -0.2
                                                                1.1
                                                                1.2];
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).cname = 'cov3';
