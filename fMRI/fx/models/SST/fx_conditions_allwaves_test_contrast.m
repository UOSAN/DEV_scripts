%-----------------------------------------------------------------------
% Job saved on 09-Aug-2023 10:44:41 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{7}.spm.stats.con.consess{1}.tcon.name = 'CONT1';
matlabbatch{7}.spm.stats.con.consess{1}.tcon.weights = [1 0];
matlabbatch{7}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{7}.spm.stats.con.consess{2}.tcon.name = 'CONT2';
matlabbatch{7}.spm.stats.con.consess{2}.tcon.weights = [0 1];
