...
conditions = {'lookNeutral', 'lookNoCrave','lookCrave','reappraiseCrave', 'instructions','ratings'
    };
base_matrix = zeros(1, size(conditions,2) + 5);

for c_i = 1:length(conditions):
    condition_matrix = base_matrix;
    condition_matrix(c_i)=1;
end
