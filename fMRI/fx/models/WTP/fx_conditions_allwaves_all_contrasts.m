...
for wave_i = 1:length(included_runs_by_wave)
    for run_i = 1:length(included_runs_by_wave{wave_i})
        ...
        matlabbatch{length(matlabbatch)}.spm.stats.fmri_spec.sess(spec_i).multi = {sprintf('/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/ROC/conditions/DEV001_%d_WTP%d.mat',wave_i,run_name)};
