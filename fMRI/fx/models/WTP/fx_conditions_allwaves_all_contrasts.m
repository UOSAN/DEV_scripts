...
% matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/sanlab/shared/DEV/bids_data/derivatives/fmriprep_2022/sub-DEV001/ses-wave2/func'};
% matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 's6_sub-DEV001_ses-wave2_task-WTP_acq-2_space-MNI152NLin2009cAsym_desc-preproc_bold.nii';
% matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
% matlabbatch{11}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/sanlab/shared/DEV/bids_data/derivatives/fmriprep_2022/sub-DEV001/ses-wave2/func'};
% matlabbatch{11}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 's6_sub-DEV001_ses-wave2_task-WTP_acq-3_space-MNI152NLin2009cAsym_desc-preproc_bold.nii';
% matlabbatch{11}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
% matlabbatch{12}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/sanlab/shared/DEV/bids_data/derivatives/fmriprep_2022/sub-DEV001/ses-wave2/func'};
% matlabbatch{12}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 's6_sub-DEV001_ses-wave2_task-WTP_acq-4_space-MNI152NLin2009cAsym_desc-preproc_bold.nii';
...
% matlabbatch{14}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (s6_sub-DEV001_ses-wave2_task-WTP_acq-2_space-MNI152NLin2009cAsym_desc-preproc_bold.nii)', substruct('.','val', '{}',{10}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
% matlabbatch{14}.spm.util.exp_frames.frames = Inf;
% matlabbatch{15}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (s6_sub-DEV001_ses-wave2_task-WTP_acq-3_space-MNI152NLin2009cAsym_desc-preproc_bold.nii)', substruct('.','val', '{}',{11}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
% matlabbatch{15}.spm.util.exp_frames.frames = Inf;
% matlabbatch{16}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (s6_sub-DEV001_ses-wave2_task-WTP_acq-4_space-MNI152NLin2009cAsym_desc-preproc_bold.nii)', substruct('.','val', '{}',{12}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(2).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_1_WTP2.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave1_task-WTP_acq-2_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(3).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_1_WTP3.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(3).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(3).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave1_task-WTP_acq-3_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(4).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_1_WTP4.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(4).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(4).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave1_task-WTP_acq-4_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(5).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_2_WTP1.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(5).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(5).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave2_task-WTP_acq-1_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(6).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_2_WTP2.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(6).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(6).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave2_task-WTP_acq-2_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(7).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_2_WTP3.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(7).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(7).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave2_task-WTP_acq-3_run-1_desc-motion_regressors.txt'};
...
%         matlabbatch{17}.spm.stats.fmri_spec.sess(8).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/conditions/DEV001_2_WTP4.mat'};
%         matlabbatch{17}.spm.stats.fmri_spec.sess(8).regress = struct('name', {}, 'val', {});
%         matlabbatch{17}.spm.stats.fmri_spec.sess(8).multi_reg = {'/projects/sanlab/shared/DEV/bids_data/derivatives/auto-motion-fmriprep/sub-DEV001/sub-DEV001_ses-wave2_task-WTP_acq-4_run-1_desc-motion_regressors.txt'};
