%-----------------------------------------------------------------------
% Job saved on 28-Jul-2021 08:40:17 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {'/projects/sanlab/shared/DEV/nonbids_data/fMRI/fx/models/WTP/wave1/betaseries_ns_w_hrf_from_spm_before_fingerpress/sub-DEV001'};
...
matlabbatch{9}.spm.stats.fmri_spec.sess(1).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/betaseries_ns_2s_before_fingerpress/DEV001_1_WTP1.mat'};
...
matlabbatch{9}.spm.stats.fmri_spec.sess(2).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/betaseries_ns_2s_before_fingerpress/DEV001_1_WTP2.mat'};
...
matlabbatch{9}.spm.stats.fmri_spec.sess(3).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/betaseries_ns_2s_before_fingerpress/DEV001_1_WTP3.mat'};
...
matlabbatch{9}.spm.stats.fmri_spec.sess(4).multi = {'/projects/sanlab/shared/DEV/DEV_scripts/fMRI/fx/multiconds/WTP/betaseries_ns_2s_before_fingerpress/DEV001_1_WTP4.mat'};
