...
ml_scripting_path = dev_scripts_path + "/fMRI/ml"
dropbox_datapath = config_data['dropbox_data_path']
wtp_level_2_path = config_data['wtp_level_2_path']
...
train_betas_with_data = get_data_for_confirmed_train_subjs(
    beta_glob = nonbids_data_path + "fMRI/fx/models/WTP/all_waves/" + analysis_name + "/sub-DEV*/",
...
contrast_name_list = [
'HealthyLiked(T2>T1)',
'UnhealthyLiked(T2>T1)',
'HealthyLiked(T2<T1)',
'UnhealthyLiked(T2<T1)',
'HealthyLikedVsUnhealthyLiked',
'UnhealthyLikedVsHealthyLiked'
]


iterate_over_l1_images_and_run_l2_scripts_w_confounds(
    contrast_name_list, betas_with_contrasts, output_name, wtp_level_2_path, config_data['template_mlr_main'], spm_path,
