...
%-----------------------------------------------------------------------
% spm('defaults','fMRI');
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Users/denicia/DEV/DEV_scripts/fMRI/fx/models/WTP/level2/prepostWTP_20230815/UnealthyVSHealthy'};
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'UnealthyVSHealthy';
