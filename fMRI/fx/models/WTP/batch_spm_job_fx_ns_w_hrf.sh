...
SCRIPT=${SCRIPTS_DIR}/fMRI/fx/models/WTP/fx_betaseries_ns_w_hrf.m

# Set shell script to execute
SHELL_SCRIPT=spm_job.sh

# RRV the results files
RESULTS_INFIX=fx_betaseries_ns_w_hrf

# Set output dir and make it if it doesn't exist
OUTPUTDIR=${SCRIPTS_DIR}/fMRI/fx/models/output_ns_w_hrf
