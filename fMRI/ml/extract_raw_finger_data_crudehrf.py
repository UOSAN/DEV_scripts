...
print("applying a hacky HRF by adding 5 seconds to the event onsets...",flush=True)
#now we do a crude, hacky HRF adjustement. Just add 5 seconds to the choice period.
#effectively now we grab the one image occuring at the peak of the HRF.
#why 5 seconds? see 
...
with open('../data/Brain_Data_raw_fingerpress_crudehrf_60subs.pkl', 'wb') as pkl_file:
