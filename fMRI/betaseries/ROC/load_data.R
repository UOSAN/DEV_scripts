...
# load ratings
file_dir = "~/Dropbox (University of Oregon)/Berkman Lab/Devaluation/Tasks/ImageSelection/output/Categorized/"
file_pattern = "DEV[0-3]{1}[0-9]{2}_ratings.csv"
file_list = list.files(file_dir, pattern = file_pattern, recursive = TRUE)[-1]
...
# load stimuli files
file_dir = "~/Dropbox (University of Oregon)/Berkman Lab/Devaluation/Tasks/ROC/output/"
file_pattern = "DEV[0-3]{1}[0-9]{2}_[1-2]{1}_stimuli.*.mat"
file_list = list.files(file_dir, pattern = file_pattern, recursive = TRUE)
