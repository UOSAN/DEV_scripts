...
def batch_jobs(subject_list, dicomdir, configfile, niidir):
    ...
    for line in lines:
        ...
        if os.path.isdir(subjectpath):
            #don't need to check the subject already exists because:
            #1. this is handled by make_converstion_list, which excludes subjects already processed.
            #2. dcm2bids doesn't process DICOM files where the output already exists.
