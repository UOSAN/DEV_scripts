...
codedir = os.path.join(parentdir, "DEV_scripts", "org", "bidsQC", "conversion") # Contains subject_list.txt, config file, and dcm2bids_batch.py
...
# Test subject
test_subject = "DEV001_20180406_170438" # Name of a directory that contains DICOMS for one participant
