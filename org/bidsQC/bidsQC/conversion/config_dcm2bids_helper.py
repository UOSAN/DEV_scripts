...
dicomdir = os.path.join(os.sep, "projects", "sanlab", "shared", "DICOMS", "eating_dicoms")
bidsdir = os.path.join(parentdir, "bids_data") # where the niftis will be put
codedir = os.path.join(parentdir, "eating_scripts", "org", "bidsQC", "conversion") # Contains subject_list.txt, config file, and dcm2bids_batch.py
...
# Test subject
test_subject = "1.3.12.2.1107.5.2.7.20418.30000012020923313556200000088" # Name of a directory that contains DICOMS for one participant
